...
class GeneradorPlaylists {
    ...
    $requiredTables = ['historial_reproduccion', 'canciones', 'generos_musicales'];
    foreach ($requiredTables as $table) {
        $result = $this->conexion->query("SHOW TABLES LIKE '$table'");
...
exit; // Asegurar que no hay salida adicional