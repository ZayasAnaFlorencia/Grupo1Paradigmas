const songs = [
    {
        ...
        audioSrc: "assets/bohemian.mp3" // Ruta relativa a tu archivo de audio
    },
    {
...
// En el método loadSong del MusicPlayer:
loadSong() {
    ...
    // Precargar la siguiente canción para mejor experiencia
    if (this.currentSong < songs.length - 1) {
        const nextSong = songs[this.currentSong + 1];
        const preload = new Audio();
        preload.src = nextSong.audioSrc;
    }
